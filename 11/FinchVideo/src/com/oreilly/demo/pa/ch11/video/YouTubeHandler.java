...
import com.oreilly.demo.pa.ch11.Ch11;
                    ...
                    if ((startName != null)) {
                        ...
                        if ((MEDIA + ":" + THUMBNAIL).equals(startName)) {
                            ...
                            for (int i = 0; i < c; i++) {
                                ...
                                if (attrName != null) {
                                    if (FinchVideo.Videos.URI_NAME.equals(attrName))
                                    {
                                        mediaEntry.put(
                                    ...
                                    {
                                        mediaEntry.put(
                                                FinchVideo.Videos.THUMB_WIDTH_NAME,
                                                attrValue);
                                    } else if (HEIGHT.equals(attrName))
                                    {
                                        mediaEntry.put(
                                                FinchVideo.Videos.THUMB_HEIGHT_NAME,
                                                attrValue);
                                    }
                                }
                            }
                    ...
                    if (endName != null) {
                        if (ENTRY.equals(endName)) {
                            ...
                            if (providerUri != null) {
                                ...
                                mFinchVideoProvider.
                                        cacheUri2File(String.valueOf(ID), thumbUri);
                            }
                        }
                    }
