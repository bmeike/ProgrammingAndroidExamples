...
public class FinchVideoContentProvider extends RESTfulContentProvider {
    ...
    private static final String FILE_CACHE_DIR =
            "/data/data/com.oreilly.demo.pa.ch11/file_cache";

    private static final int VIDEOS = 1;
    private static final int VIDEO_ID = 2;
    private static final int THUMB_ID = 3;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void createTable(SQLiteDatabase sqLiteDatabase) {
            String createvideoTable =
                    ...
                    FinchVideo.Videos._ID + " INTEGER PRIMARY KEY, " +
            ...
            throws FileNotFoundException
    {
        ...
        switch (match) {
            case THUMB_ID:
                long thumbID = ContentUris.parseId(uri);
                File cachedFile = mFileHandlerFactory.getFile(thumbID);
                if (cachedFile != null) {
                    return ParcelFileDescriptor.open(cachedFile,
