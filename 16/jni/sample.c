...
jdouble Java_com_oreilly_demo_pa_ch16_SampleActivityWithNativeMethods_calculatePower( JNIEnv* env, jobject thisobject, jdouble x, jdouble y) {
...
jstring Java_com_oreilly_demo_pa_ch16_SampleActivityWithNativeMethods_whatAmI(JNIEnv* env, jobject thisobject) {
