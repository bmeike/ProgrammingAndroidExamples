package com.oreilly.demo.pa.ch15.sync.authsync;

import java.util.ArrayList;

import com.oreilly.demo.pa.ch15.sync.NetworkUtil;
import com.oreilly.demo.pa.ch15.sync.dataobjects.Change;
import com.oreilly.demo.pa.ch15.sync.dataobjects.ListFriends;
import com.oreilly.demo.pa.ch15.sync.dataobjects.User;
...
import com.oreilly.demo.pa.ch15.R;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        String authtoken = null;
         try {
             ...
             ListFriends friendsdata = ListFriends.fromJSON(NetworkUtil.getFriends(context.getString(R.string.baseurl), authtoken, lastsynctime, null));
    ...
    private ArrayList<ContentProviderOperation> add(Account account, User f) {
    	...
    	ops.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
    			.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, 0)
    			.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.com.oreilly.demo.pa.ch15.sync.profile")
