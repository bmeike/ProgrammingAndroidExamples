package com.oreilly.demo.pa.ch15.sync;

import org.json.JSONObject;

import com.oreilly.demo.pa.ch15.sync.authsync.Authenticator;
...
public class LoginActivity extends AccountAuthenticatorActivity {
	...
	private void login() {
		...
		NetworkUtil.login(getString(R.string.baseurl), username, password, loginHandler);
	}
