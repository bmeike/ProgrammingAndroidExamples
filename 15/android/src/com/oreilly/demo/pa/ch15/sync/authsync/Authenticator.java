...
import com.oreilly.demo.pa.ch15.sync.LoginActivity;
...
public class Authenticator extends AbstractAccountAuthenticator {
	public static final String AUTHTOKEN_TYPE 				= "com.oreilly.demo.pa.ch15.sync";
	public static final String ACCOUNT_TYPE					= "com.oreilly.demo.pa.ch15.sync";
    ...
    public Bundle confirmCredentials(AccountAuthenticatorResponse response, Account account, Bundle options) {
    	if (options != null && options.containsKey(AccountManager.KEY_PASSWORD)) {
            ...
            JSONObject json = NetworkUtil.login(context.getString(R.string.baseurl), account.name, password, true, null);
