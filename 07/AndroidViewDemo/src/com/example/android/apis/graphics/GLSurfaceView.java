    ...
    implements SurfaceHolder.Callback
{
    ...
    public interface Renderer {
        ...
        /**
         * Surface created. Called when the surface is created. Called when
         * the application starts, and whenever the GPU is reinitialized. This
         * will typically happen when the device awakes after going to sleep.
         ...
         * whenever the OpenGL ES surface size changes. Set your viewport
         * here.
         * 
         * @param gl
         * @param width
